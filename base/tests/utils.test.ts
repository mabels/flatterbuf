...
test(`[]`, () => {
  expect(nestedAssign<undefined | Array<undefined | number>>(undefined, undefined, [], [])).toEqual(NoneOption);
});

test(`[undefined, undefined]`, () => {
  expect(nestedAssign<undefined | Array<number | undefined>>(undefined, undefined, [undefined], [undefined, undefined])).toEqual(
    NoneOption,
  );
});

test(`[[1, undefined], [undefined, 2]]`, () => {
  expect(nestedAssign<undefined | Array<number | undefined>>(undefined, undefined, [1, undefined], [undefined, 2])).toEqual(
    SomeOption([1, 2]),
  );
});
...
test(`[[{a:1, b: 2}, {a: 3, c: 4}], [{a: 3, b: 1, c: 4}, { b: 5 }]]`, () => {
  expect(
    nestedAssign<undefined | Array<Record<string, number>>>(
      undefined,
      undefined,
      [
        { a: 1, b: 2 },
...
test(`[[undefined, 2], [1, 5, undefined], [ 3, 2, 1, 4]]`, () => {
  expect(
    nestedAssign<undefined | Array<number | undefined | Array<number | undefined>>>(undefined, undefined, [undefined, 2], [1, 5, undefined], [3, 2, 1, 4]),
